...
| Role             | Token                             | Rule                                                                                |
| ---------------- | --------------------------------- | ----------------------------------------------------------------------------------- |
| Page ground      | `--background`                    | Cool near-white. Never warm beige.                                                  |
| Working surface  | `--card`                          | Pure white panels on the ground.                                                    |
...
- Geist Sans for all interface text. Geist Mono only for identifiers, dates, rates, counters and operational metadata.
...
- 4/8px spacing increments. Compact but breathable; a dense row is `py-3`, a panel is `p-4` or `p-5`.
