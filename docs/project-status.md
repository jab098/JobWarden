...
- [Task 10 live recovery state](handoffs/task-10-current-state.md)
...
- Current integration branch: `main`; Task 9 was delivered by PR #10 at merge commit `44a3580`
...
- Task 10 remediation head: `0d315eb` plus the consolidated final-review follow-up at branch `HEAD`; a clean re-review and publication remain pending
...
| 10. Career profile, onboarding, and CV extraction                      | active   | Final-review fixes at `HEAD`; clean re-review/PR #11 pending  |
