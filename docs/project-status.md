...
- Task 10 remediation head: `b0d4da3`; all three remediation slices independently passed specification and quality review, while the final whole-branch review and publication remain pending
...
| 10. Career profile, onboarding, and CV extraction                      | active   | Remediation complete; final review/PR #11 merge pending       |
