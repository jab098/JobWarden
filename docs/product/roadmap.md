...
| 21   | Authentication activation                                                  | done     | Live Supabase project and Google OAuth; runbook steps 1–5 complete 2026-07-21         |
...
8. ~~**Task 21 — authentication activation.**~~ **Done, 2026-07-21.** A live Supabase project, Google OAuth and an approved administrator all exist, and the hub has been used against them end to end. Runbook steps 1–5 are complete; the remaining production work resumes at step 6 (deploy). Running those steps for the first time found nine defects, every one in a path only a real account or a real CV could reach — they are listed in `docs/project-status.md`.
