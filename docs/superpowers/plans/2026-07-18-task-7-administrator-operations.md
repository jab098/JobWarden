...
- [ ] **Step 2: Implement the same-origin helper and verify**
...
- [ ] **Step 4: Implement minimal orchestration and stable error mapping**
...
- [ ] **Step 6: Commit the use-case layer**
...
- [ ] **Step 2: Implement and verify the adapter**
...
- [ ] **Step 3: Write the failing fictional-preview test**
...
- [ ] **Step 4: Implement preview data and production factory**
...
- [ ] **Step 2: Implement the shared protected layout and pages**
...
- [ ] **Step 3: Implement thin Server Action wrappers**
...
- [ ] **Step 3: Implement the editorial admin composition**
...
- [ ] **Step 4: Implement the read-only development preview guard**
...
- [ ] **Step 5: Run UI tests and React checklist**
...
- [ ] **Step 2: Run production fail-closed probes**
...
- [ ] **Step 3: Verify the browser at desktop and true 390 px**
...
- [ ] **Step 4: Run secret and forbidden-concept scans**
...
- [ ] **Step 5: Complete independent review and remediate findings**
...
- [ ] **Step 6: Update durable status and commit delivery evidence**
