...
export function TailoringWorkspaceView({
  ...
  if (!workspace.source.available) {
    return (
      <section className="px-5 py-10 lg:px-8">
        <h1 className="text-2xl font-semibold tracking-[-0.025em] text-[#172033]">
          A DOCX CV is required
        </h1>
        <p className="mt-3 max-w-prose text-sm leading-6 text-[#596173]">
  ...
  return (
    <div className="px-5 py-8 lg:px-8">
      ...
      <p className="mt-1 text-sm text-[#596173]">{workspace.job.employer}</p>
      <p className="mt-3 max-w-prose text-sm leading-6 text-[#596173]">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(16rem,0.5fr)]">
        <div className="min-w-0">
          <ol className="divide-y divide-[#ece9e2] border-y border-[#ece9e2]">
              ...
              return (
                <li key={paragraph.index} className="py-4">
                  <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
                    <span className="font-mono text-[0.68rem] uppercase tracking-[0.14em] text-[#697181]">
                    ...
                    <span className="text-xs text-[#697181]">
                      {relevant ? (
                        <>
                          <span
                            aria-hidden="true"
                            className="mr-2 inline-block size-2 rounded-full bg-[#2f6f4f] align-middle"
                          />
                        ...
                        <>
                          <span
                            aria-hidden="true"
                            className="mr-2 inline-block size-2 rounded-full bg-[#9aa1ae] align-middle"
                          />
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#596173] [overflow-wrap:anywhere]">
                    {paragraph.text || "(empty paragraph)"}
                  </p>

                  {paragraph.text === "" ? null : (
                    <div className="mt-3 space-y-2">
                      <label className="flex items-center gap-2 text-sm text-[#263248]">
                        <input
                          type="checkbox"
                          ...
                          className="size-4 accent-[#2458a6]"
                        />
        ...
        <aside className="min-w-0 lg:border-l lg:border-[#ece9e2] lg:pl-6">
          ...
          {review.changes.length === 0 ? (
            ...
            <ul className="mt-2 space-y-2 text-sm text-[#596173]">
                ...
                >
                  <span
                    ...
                    className={`mr-2 inline-block size-2 rounded-full align-middle ${
                      change.accepted ? "bg-[#2f6f4f]" : "bg-[#8a3328]"
                    }`}
                  />
          ...
          <p className="mt-3 text-xs text-[#697181]">
          ...
          {workspace.variant ? (
            <div className="mt-6 space-y-3 border-t border-[#ece9e2] pt-5">
              <h2 className="text-sm font-semibold text-[#263248]">
          ...
          {readOnly ? (
            <p className="mt-5 text-sm text-[#596173]">
