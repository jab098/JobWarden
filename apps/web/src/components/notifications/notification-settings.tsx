...
export function NotificationSettings({
  ...
  return (
    <section
      ...
      className="border-t border-[#dedbd2] px-5 py-8 lg:px-8"
    >
      ...
      <h2
        ...
        className="mt-1 text-xl font-semibold tracking-[-0.02em] text-[#172033]"
      >
        Digest emails
      </h2>
      ...
      <div className="mt-6">
        <h3 className="text-sm font-medium text-[#263248]">
        ...
        {result.notifyingProfileNames.length === 0 ? (
          ...
          <ul className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-sm text-[#596173]">
      ...
      <div className="mt-6">
        <h3 className="text-sm font-medium text-[#263248]">Recent slots</h3>
        {result.recentDeliveries.length === 0 ? (
          ...
          <ul className="mt-2 divide-y divide-[#ece9e2] border-y border-[#ece9e2]">
            {result.recentDeliveries.map((delivery) => {
              ...
              return (
                ...
                >
                  <span className="font-mono text-xs text-[#697181]">
