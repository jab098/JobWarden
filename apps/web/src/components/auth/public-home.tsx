...
export function PublicHome({ dataMode }: PublicHomeProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-clip bg-[#f4f1ea] text-[#172033]">
      <main className="flex flex-1 flex-col">
        <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-5 py-6 sm:px-8 lg:px-12 lg:py-8">
          ...
          <div className="grid flex-1 items-center gap-14 py-16 lg:grid-cols-[minmax(0,1.15fr)_minmax(19rem,0.7fr)] lg:gap-24 lg:py-24">
            <section aria-labelledby="home-title" className="min-w-0 max-w-3xl">
              ...
              <p className="mt-7 max-w-xl text-base leading-7 text-[#596173] sm:text-lg sm:leading-8">
                JobWarden gathers permitted UK listings, including contract
                work, and keeps the evidence behind every classification
                visible. Applications stay in your hands on the employer&apos;s
                site.
              </p>
      ...
      <div className="mx-auto w-full max-w-7xl px-5 pb-6 sm:px-8 lg:px-12 lg:pb-8">
        <PublicFooter />
      </div>
    </div>
  );
