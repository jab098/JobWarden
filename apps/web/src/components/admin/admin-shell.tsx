...
export function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-[#f4f1ea] text-[#172033]">
      {preview ? (
        <p className="border-b border-[#b9c9df] bg-[#eaf0f8] px-5 py-2 text-center text-xs font-medium text-[#244873]">
      ...
      <header className="border-b border-[#d8d4cb] px-5 py-4 lg:hidden">
        ...
        <div className="mt-3 overflow-x-auto">
          <AdminNavigation label="Administrator mobile" />
        </div>
      </header>
      <aside className="fixed inset-y-0 left-0 hidden w-56 border-r border-[#d8d4cb] bg-[#f4f1ea] lg:flex lg:flex-col">
        ...
        <div className="p-3">
          <AdminNavigation label="Administrator primary" />
        </div>
