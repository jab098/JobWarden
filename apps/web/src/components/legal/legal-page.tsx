...
export function LegalPage({
  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <p className="mt-1 text-xs text-[#697181]">Last updated {updated}</p>
      <div className="mt-6 space-y-4 text-sm leading-6 text-[#596173] [&_a]:underline [&_a]:underline-offset-4 [&_h2]:mt-8 [&_h2]:text-sm [&_h2]:font-semibold [&_h2]:text-[#263248] [&_li]:mt-1 [&_strong]:text-[#263248] [&_ul]:list-disc [&_ul]:pl-5">
        {children}
      </div>
