...
describe("administrator mutation origin", () => {
  ...
  it.each([
    ...
    ["origin path", { requestOrigin: "https://jobwarden.example/admin" }],
    ["origin query", { requestOrigin: "https://jobwarden.example?next=1" }],
    ["origin fragment", { requestOrigin: "https://jobwarden.example/#admin" }],
    ["origin control", { requestOrigin: "https://jobwarden.example\n" }],
